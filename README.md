...
>  An OOP ruby applet to manage university's library 
...
> This is the best program a librarian will ever need! 
...
```sh
 git clone https://github.com/Goldinium/OOP-school-library.git
```
